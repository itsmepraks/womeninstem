...
export default function Footer() {
  ...
  return (
    <footer className="relative border-t border-neutral-200 dark:border-neutral-800 mt-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
              {footerSections.map((section) => (
                <div key={section.title}>
                  <h3 className="font-display font-semibold text-neutral-900 dark:text-neutral-100 mb-4">
                    {section.title}
                  </h3>
        ...
        {/* Newsletter Section */}
        <div className="bg-neutral-50 dark:bg-neutral-900 rounded-xl p-6 md:p-8 mb-12">
          <div className="grid md:grid-cols-2 gap-6 items-center">
            <div>
              ...
              <p className="text-neutral-600 dark:text-neutral-400 text-sm">
                Get notified about new content and opportunities.
              </p>
            </div>
            <div className="flex flex-col sm:flex-row gap-3">
              <input
                ...
                className="flex-1 px-4 py-2 bg-white dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
              />
      ...
      {showBackToTop && (
        <button
          onClick={scrollToTop}
          className="fixed bottom-8 right-8 px-4 py-2 bg-primary-600 text-white rounded-lg shadow-lg hover:bg-primary-700 transition-all z-40 text-sm font-medium"
